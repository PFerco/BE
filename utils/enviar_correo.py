...
from email.mime.application import MIMEApplication #sirve para agregar archivos
...
>
  ...
  >
    ...
    #Agregamos el tituo  nuestro mensaje
    ...
    emisor = SMTP('smtp.office365.com',587)
...
def enviar_correo_adjuntos(destinatarios, titulo):
  cuerpo = 'Por favor, revisa los adjuntos'
  ...
  mensaje.attach(MIMEText(cuerpo))
  #getcwd > nos devule la ruta en la cual esta nuestro archivo principal del proyecto en el servidor (app.py)
  ruta=getcwd()
  #path.join > en base a los parametros que le pasemos creara la cadena de direccion ya sea con '/' o con '\'
