...
class PruebaView(APIView):
    ...
    def post(self, request):
        ...
        # me retornara Verdadero o Falso si la data es correcta
...
class CategoriaView(APIView):
    ...
    def get(self, request:Request):
        ...
        # NOTA cuando se pasa instancias se utiliza el parametro 'instance' y cuando se pasa informacion para validar se  utiliza el parametrro 'data'
...
class UnaCategoriaView(APIView):
    def get(self,request:Request,id):
        ...
        resultado = CategoriaSerializer(instance=categoria_encontrada) #por defecto many = false
    ...
    def delete(self, request:Request, id):
        ...
        #me retorna el total de registros eliminados en una tupla de la siguietne manera
